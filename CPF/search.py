...
# Embedded file name: C:\Users\yoadlew\Dropbox\AI2014\ProgrammingExs13\searchSol\search.py
# Compiled at: 2014-11-02 21:26:36
...
def greedySearch(problem, heuristic=nullHeuristic):
    ...
    return graphSearch(problem, util.PriorityQueueWithFunction(lambda node: heuristic(node.state, problem)))
